...
namespace Fido2NetLib
{
    ...
    public sealed class AuthenticatorAttestationResponse : AuthenticatorResponse
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            // 16. If the Relying Party uses the credential's backup state to inform its user experience flows and/or policies, evaluate the BS bit of the flags in authData.
            if (authData.BackupState)
        ...
        private void VerifyTrustAnchor(MetadataBLOBPayloadEntry metadataEntry, X509Certificate2[] trustPath)
        {
